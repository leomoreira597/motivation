...
class Mock {
    private val all = MotivationConsts.FILTER.ALL
    private val happy = MotivationConsts.FILTER.HAPPY
    private val sunny = MotivationConsts.FILTER.SUNNY
    ...
    fun getPhrase(value: Int): String{
        ...
        val index = Random.nextInt(filtred.size)
        return filtred[index].description
    }
